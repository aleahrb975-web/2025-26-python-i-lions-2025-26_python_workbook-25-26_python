...
def MPG():
    #get inputs
    miles=int(input("How many American Miles?"))
    gallon=int(input("How many American Gallons?"))
    #convert
    liters= gallon*3.78541
    kilometer=miles*1.6
    print("The fuel efficiency is "+str(liters/(kilometer/100)) +"L/100Km")
...
def distance():
    t1=int(input("Latitude of point 1:"))
    g1=int(input("Longitude of point 1:"))
    t2=int(input("Latitude of point 2:"))
    g2=int(input("Longitude of point 2:"))
    t1=math.radians(t1)
    t2=math.radians(t2)
    g1=math.radians(g1)
    g2=math.radians(g2)
    distance = 6371.01 * math.acos(math.sin(t1) * math.sin(t2) + math.cos(t1) * math.cos(t2) * math.cos(g1-g2))
    print("The distance between these points is: " +str(distance)+" Km")
#distance()
"""
...
def change():
    ...
    print(str(toonie)+" toonies; "+str(loonie)+" loonies; "+str(quarter)+" quarters; "+str(dime)+" dimes; "+str(nickel)+" nickles; "+str(penny)+" pennies.")
#change()
"""
...
def height():
    ...
    cm=inches*2.54
    print("Your height is: "+str(cm)+" centimeters")
...
def units():
    ...
    yard=feet/3
    miles=feet/5280
    print("in inches: "+str(inches)+"; in yards: "+str(yard)+"; in miles "+str(miles))
